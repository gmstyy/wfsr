	...
	<table class="edittable">
		...
		<tbody>			
			...
			<tr>
				<th>立案日期：</th>
				<td>
					<input type="text" value="<fmt:formatDate value='${entity.acceptTime}' pattern='yyyy-MM-dd' />" name="acceptTime"/>
				</td>
			</tr>						
			<tr>
				<th>案由：</th>
			...
			<tr>
				<th>经办人</th>
				<td>
					<input type="text" value="${casef.usersName}" name="usersName" style="width:78.5%;"/>
				</td>
			</tr>
			<tr>
				<th>当前状态</th>
				<td>
					<hs:v dicName='CASE_FINISH_STATUS' code="${casef.status}"></hs:v>
				</td>
			</tr>																													
		</tbody>			
	</table>
