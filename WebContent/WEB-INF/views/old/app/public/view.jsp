...
<table class="edittable">
	...
	<tr>
		...
		<td><hs:dic dicName='RELATIVE_PERSON_BUSINESS_TYPE' disabled="true" id='businessType' name='businessType' defalt="${app.businessType}" blank="false" value1 = "01" /></td>
	</tr>
	<tr>
		<th>职工人数</th>
	...
	<tr>
		<th>固定资产（万元）</th>
		<td><input type='text' value='${app.fixedAssets}' id='fixedAssets' name='fixedAssets' maxlength='10' readonly="readonly" /></td>
		<th>使用面积</th>
		<td><input type='text' value='${app.area}' id='area' name='area' maxlength='10' readonly="readonly" /></td>
	</tr>
	<tr>
		<th>竣工验收许可证号</th>
		<td><input type='text' value='${app.completeLicenseNo}' id='completeLicenseNo' name='completeLicenseNo' maxlength='30' readonly="readonly" /></td>
		<th>原卫生许可证号</th>
		<td><input type='text' value='${app.oldLicenseNo}' id='oldLicenseNo' name='oldLicenseNo' maxlength='20' readonly="readonly" /></td>
	</tr>
	<%--<tr>
		<th>卫生许可编号</th>
