...
<table class="edittable">
	...
	<tr>
		...
		<td><input type='text' value='${app.pracInstName}' id='pracInstName' name='pracInstName' maxlength='100'/>
		</td>
		<th>填表时间<span class="must_field">*</span></th>
		<td><tag:dateInput date='${app.fillingTime}' id='fillingTime' name='fillingTime'/></td>
	</tr>
	<tr>
		<th>性别<span class="must_field">*</span></th>
		<td><hs:dic dicName='GENDER' id='gender' name='gender' defalt="${app.gender}" value1="1"></hs:dic></td>
		<th>出生年月<span class="must_field">*</span></th>
		<td><tag:dateInput date='${app.birthYearMonth}' id='birthYearMonth' name='birthYearMonth'/></td>
	</tr>
	<tr>
		<th>籍 贯<span class="must_field">*</span></th>
		<td><input type='text' value='${app.nativePlace}' id='nativePlace' name='nativePlace' maxlength='50'/></td>
		<th>民族<span class="must_field">*</span></th>
		<td><hs:dic dicName="ETHNIC" defalt='${app.nation}' id='nation' name='nation' /></td>
	</tr>
	<tr>
		<th>学历/学位<span class="must_field">*</span></th>
		<td><hs:dic dicName='DEGREE' id='degree' name='degree' defalt="${app.degree}"/></td>
		<th>传真</th>
		<td><input type='text' value='${app.fax}' id='fax' name='fax' maxlength='30'/></td>
	</tr>
	<tr>
		<th>现任专业技术职务及
			任职时间、聘任单位
		</th>
		<td colspan="3"><textarea name="positionDescribe" id="positionDescribe" cols="70" rows="5" maxlength="200">${app.positionDescribe}</textarea></td>
	</tr>
	<tr>
		<th>现有专业技术职务任职
			资格及取得时间、审批机关
		</th>
		<td colspan="3"><textarea name="jobQualifications" id="jobQualifications" cols="70" rows="5" maxlength="200">${app.jobQualifications}</textarea></td>
	</tr>
	<tr>
		<th>申请专业<span class="must_field">*</span></th>
		<td><hs:dic dicName='APPLY_MAJOR' id='applyMajor' name='applyMajor' defalt="${app.applyMajor}"/></td>
	</tr>
	<tr>
		<th>本人专业技术工作述评</th>
		<td colspan="3"><textarea name="workReview" id="workReview" cols="70" rows="5" maxlength="200">${app.workReview}</textarea></td>
	</tr>
	<%--<tr>
		<th>执业机构(单位)意见</th>
...
<script type="text/javascript">
	var getAppParams = function(formData) {
		formData.learningList =  getDataList("learningList", "tbody");
		formData.workingList =  getDataList("workingList", "tbody");
