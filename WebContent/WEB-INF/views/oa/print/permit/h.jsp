...
<div style="width:80%;height:100%;">
	...
	<p style='text-indent:28.0pt;text-align:left;'>
		<span style='font-size:14.0pt;font-family:仿宋_GB2312'>你（单位）提出</span>
		<u><span style='font-size:14.0pt;font-family:仿宋'><hs:v dicName='LICENSE_TYPE' code='${app.licenseType}'/></span></u>
		<span style='font-size:14.0pt;font-family:仿宋_GB2312'>（1、变更；2、延续）行政许可申请，根据</span>
		<u><span style='font-size:14.0pt;font-family:仿宋'>${rule}</span></u>
		<span style='font-size:14.0pt;font-family:仿宋_GB2312'>的规定，经审查，不符合法定的条件和标准，本机关决定不予</span>
		<u><span style='font-size:14.0pt;font-family:仿宋'></span></u>
		<span style='font-size:14.0pt;font-family:仿宋_GB2312'>（1、变更；2、延续）。</span>
	</p>
