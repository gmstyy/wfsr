...
<div style="width:80%;height:100%;">
	...
	<p style='text-align:center;'>
		<b><span style='font-size:16.0pt;font-family:宋体'>行政许可申请不予受理决定书</span></b>
	</p>
	...
	<p style='text-indent:28.0pt;text-align:left;'>
		...
		<fmt:formatDate value="${app.applyDatetime}" pattern="yyyy年MM月dd日"/>提出的关于<hs:v dicName='LICENSE_TYPE' code='${app.licenseType}'/>行政许可申请，不符合法定的受理条件，本机关决定不予受理。具体理由如下：</span>
	</p>
	
	<p style='text-indent:28.0pt;text-align:left;'>
		<span style='font-size:14.0pt;font-family:仿宋'>${app.handleReason}</span>
	</p>
