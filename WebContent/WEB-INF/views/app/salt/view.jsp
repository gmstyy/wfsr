...
<table class="edittable">
	...
	<tr>
		...
		<td colspan="3"><input type='text' value='${app.actualProductionAddress}' id='actualProductionAddress'
		                       name='actualProductionAddress' maxlength='200' style="width: 80%" readonly="readonly"/></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<th>邮编</th>
		<td><input type='text' value='${app.zipCode}' id='zipCode' name='zipCode' readonly="readonly"/></td>
	</tr>
	<%--<tr>
		<th>业务六处意见</th>
	...
	<tr>
		...
		<td><input type='text' value='${app.approvalNumber}' id='approvalNumber' name='approvalNumber'
		           maxlength='30' style="width: 100%" readonly="readonly"/></td>
	</tr>
	<tr>
		<th>批准日期</th>
		<td><tag:dateInput date='${app.approvalDate}' id='approvalDate' name='approvalDate' disabled="true"/></td>
		<th>截止日期</th>
		<td><tag:dateInput date='${app.endDate}' id='endDate' name='endDate' disabled="true" /></td>
	</tr>
	</tbody>
</table>