<%--@elvariable id="app" type="com.founder.oa.entity.business.AppAdvertisement"--%>
...
<table class="edittable">
	...
	<tr>
		...
		<td><hs:dic type="radio" dicName="AD_ORG_TYPE" name="applyOrgType" defalt="${app.applyOrgType}" blank="false"/></td>
		<th>所有制形式</th>
	...
	<tr>
		...
		<td><tag:dateInput date='${app.checkValidityPeriodBegin}' id='checkValidityPeriodBegin'
		                   name='checkValidityPeriodBegin'/></td>
		<th>校验有效期结束</th>
		<td><tag:dateInput date='${app.checkValidityPeriodEnd}' id='checkValidityPeriodEnd'
		                   name='checkValidityPeriodEnd'/></td>
	</tr>
	<tr>
		<th>医疗机构类别<span class="must_field">*</span></th>
		<td><hs:dic dicName='ORG_TYPE' id='institutionsCategories' name='institutionsCategories' defalt="${app.institutionsCategories}"/></td>
		<th>诊疗科目<span class="must_field">*</span></th>
		<td><input type='text' value='${app.diagnosisTreatmentSubject}' id='diagnosisTreatmentSubject'
		           name='diagnosisTreatmentSubject' maxlength='50'/></td>
	</tr>
	<tr>
		<th>床 位 数</th>
		<td><input type='text' value='${app.bedNumber}' id='bedNumber' name='bedNumber' maxlength='11'/></td>
		<th>接诊时间</th>
		<td><tag:dateInput date='${app.acceptsTime}' id='acceptsTime' name='acceptsTime'/></td>
	</tr>
	<tr>
		<th>发布媒体类别<span class="must_field">*</span></th>
		<td colspan="3"><hs:dic type="checkbox" defalt="${app.publishMediaCategory}" dicName='PUBLISH_MEDIA_TYPE' id='publishMediaCategory' name='publishMediaCategory'/></td>
	</tr>
	<tr>
		<th>广告时长(影视、声音)</th>
		<td><input type='text' value='${app.advertisTime}' id='advertisTime' name='advertisTime' maxlength='11'/>
		</td>
	</tr>
	<tr>
		<th>经办人</th>
		<td><input type='text' value='${app.agent}' id='agent' name='agent' maxlength='50'/></td>
		<th>经办人身份证号</th>
		<td><input type='text' value='${app.agentIdNo}' id='agentIdNo' name='agentIdNo' maxlength='18'/></td>
	</tr>
	</tbody>
</table>
