...
<form id="goBackEditFormId" action="" method="post">
...
<%-- 			<tr>
			...
			<tr>
				...
				<td colspan="4"><textarea rows="5" id="replyContent" name="replyContent" style="width:83%" maxlength='1000'>${complaints.replyContent}</textarea></td>
			</tr>
		</tbody>
	</table>
</form>